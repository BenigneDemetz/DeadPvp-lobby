...
public class Builder extends Gui {

    public Builder(PlayerGuiUtils playerGuiUtils) {
    ...
    public void EventHandler(InventoryClickEvent e) throws IOException {
        AdminGuiUtils.adminGuiEvent(e, "build", "builder_serv");
    }

    @Override
    protected void setItems() {
        AdminGuiUtils.adminGuiItems(inv, "build");
    }
}
